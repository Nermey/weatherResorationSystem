...
class Transformer(nn.Module):
    ...
    def forward(self,x):
        ...
        inp_dec_level3 = F.interpolate(inp_dec_level3,(inp_enc_level3.shape[2],inp_enc_level3.shape[3]),mode="bicubic")
        ...
        inp_dec_level2 = F.interpolate(inp_dec_level2,(inp_enc_level2.shape[2],inp_enc_level2.shape[3]),mode="bicubic")
        ...
        inp_dec_level1 = F.interpolate(inp_dec_level1,(inp_enc_level1.shape[2],inp_enc_level1.shape[3]),mode="bicubic")
        ...
        inp_dec_level0 = F.interpolate(inp_dec_level0,(inp_enc_level0.shape[2],inp_enc_level0.shape[3]),mode="bicubic")
