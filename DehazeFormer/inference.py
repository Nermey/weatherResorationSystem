...
model = DehazeFormerInference(
    variant="b",
    weights_path="./dehazeformer-b-2.pth",
    dehazeformer_root=".",
    device="mps",
)

# img = Image.open("./fog.jpg")
# result = model(img)
...
INPUT_DIR = BASE_DIR / "WeatherBench" / "haze" / "test" / "input"
TARGET_DIR = BASE_DIR / "WeatherBench" / "haze" / "test" / "target"
